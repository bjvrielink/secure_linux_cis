# This is a wrapper class that declares the CIS controls for Ubuntu 18.04 LTS (bionic)
#
# The Ubuntu 18.04 CIS Benchmark is updated for version: 1.0.0
#
# The benchmark can be found here:
# https://downloads.cisecurity.org/
#
# @summary This wrapper class declares CIS controls for the Ubuntu Linux 18.04 Benchmark v1.0.0
#
...
#
# @example
#   include secure_linux_cis::ubuntu18_04
class secure_linux_cis::ubuntu18_04 (
  ...
  Enum['postfix', 'exim', 'none']       $mta                     = 'none',
